...
<%-- draggable="true" : 드래그 할 요소에 추가
	 ...
	 놓기를 가능하게 하기 위해서는 반드시 요소의 기본 핸들링을 막아야 한다.
	 event.preventDefault() 메소드를 호출함으로써 기본핸들링을 막아 해당 요소에 놓여질 수 있게 만든다.
 ...
 --%>
	...
	<div id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
		<img src="img/04.jpg" draggable="true" ondragstart="drag(event)" id="drag1" width="88" height="31">
	</div>
